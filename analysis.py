...
def run_analysis():
    try:
        ...
        # 2. Token Counting & Categorization
        counts = Counter(all_tokens)
        
        track_languages = {
            'python', 'javascript', 'typescript', 'go', 'rust', 'java', 'cpp', 'c++', 'c#', 'php', 
            'ruby', 'swift', 'kotlin', 'sql', 'shell', 'bash', 'perl', 'scala', 'dart', 'lua',
            'html', 'css', 'react', 'node', 'vue', 'angular'
        }
